...
flavour: "\"Blessed are my children, for they see the beauty in simple things.\""
section: "characters"
toc: true
---
...
##  How to Run
When the game begins, give the Ug hat to any player. If you or any player catches that player saying a multisyllabic word, give the Ug hat to a different player.

If the player wearing the Ug hat votes, it counts as two votes.

Optional rule: If wearing the Ug hat becomes unfunny, limit it to the nomination phase only.
